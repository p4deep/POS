...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        if($transaction_type == 'sell'){
            $lines = $transaction->sell_lines()->whereNull('parent_sell_line_id')->with(['modifiers'])->get();
     ...
     * @return array
     */
    public function getReturnReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        $il = $invoice_layout;
        ...
        $output['final_total'] = $this->num_f($transaction->final_total, $show_currency);
