...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        if($this->restUtil->is_service_staff($user_id)){
            ...
            $orders = $this->restUtil->getAllOrders($business_id, array('waiter_id' => $user_id));
        } elseif (!empty(request()->service_staff)) {
            $orders = $this->restUtil->getAllOrders($business_id, array('waiter_id' => request()->service_staff));
        }
