        ...
        try {
        	...
        	if ($request->hasFile('products_csv')) {
        		...
        		foreach ($imported_data as $key => $value) {
					...
					//Custom fields
        			if(isset($value[29])){
        				$product_array['product_custom_field1'] = trim($value[29]);
        			} else {
        				$product_array['product_custom_field1'] = '';
        			}
					if(isset($value[30])){
        				$product_array['product_custom_field2'] = trim($value[30]);
        			} else {
        				$product_array['product_custom_field2'] = '';
					}
					if(isset($value[31])){
        				$product_array['product_custom_field3'] = trim($value[31]);
        			} else {
        				$product_array['product_custom_field3'] = '';
					}
					if(isset($value[32])){
        				$product_array['product_custom_field4'] = trim($value[32]);
        			} else {
